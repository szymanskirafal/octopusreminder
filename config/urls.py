...
urlpatterns = [
    ...
    # User management
    url(r'^users/', include('octopus.users.urls', namespace='users')),
    ...
    url(r'^octopus.png$', RedirectView.as_view(url=staticfiles_storage.url('images/octopus.png'),),name="octopus"),
